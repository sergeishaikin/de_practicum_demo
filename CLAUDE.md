...
- Planning lives in `openspec/` (see the Planning methodology section of `AGENTS.md`): `openspec/specs/` for standing capabilities, `openspec/changes/` for proposals in flight.
