...
out of scope until separately authorised. The Kafka producer, Spark streaming jobs, and Airflow DAG code are explicitly outside the first adopted wave.
Stdout SHALL remain available as a fallback.
