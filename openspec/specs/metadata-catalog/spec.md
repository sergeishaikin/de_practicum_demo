...
Define the opt-in OpenMetadata control-plane contract for searchable assets,
ownership, dbt context, and evidence-backed lineage while preserving existing
execution, storage, runtime-edge, and operational-telemetry authorities.
