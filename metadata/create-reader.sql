...
GRANT USAGE ON SCHEMA core, stg, marts TO :"reader_user";
GRANT SELECT ON ALL TABLES IN SCHEMA core, stg, marts TO :"reader_user";
GRANT SELECT ON ALL SEQUENCES IN SCHEMA core, stg, marts TO :"reader_user";
ALTER DEFAULT PRIVILEGES FOR ROLE app IN SCHEMA core, stg, marts
