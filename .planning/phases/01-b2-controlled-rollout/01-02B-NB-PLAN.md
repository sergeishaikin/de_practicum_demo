...
must_haves:
  ...
  artifacts:
    ...
    - path: "artifacts/b2-rollout/02b-new-baseline-volume-investigation.json"
      provides: "Read-only Compose/runtime volume reconciliation explaining the expected pre-recreation migration state"
      contains: "resolved_compose_source, current_mount_source, effective_log_dir, preflight_decision"
